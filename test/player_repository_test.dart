...
void main() {
  test('PlayerRepository saves and reads player profile', () async {
    ...
    final Result<PlayerProfile> loadedResult = await repository.getPlayerProfile();
    final PlayerProfile loaded = (loadedResult as Success<PlayerProfile>).value!;

    expect(save is Success<void>, true);
